  ...
  <main class="checkout-main">
    <div class="container py-4 d-flex justify-content-between text-white">
      <div class="row">
        ...
        <div class="right col-12 col-lg-6 p-4">
          <div v-if="store.cart.length > 0" class="card p-4 form-card">
            ...
            <form @submit.prevent="sendOrder()" id="payment-form" method="" class="card-form px-3">
              <div class="mb-3">
                ...
                <input max="50" class="form-control" v-model="customer_name" type="text" name="customer_name"
                  id="customer_name" />
              ...
              <div class="mb-3">
                ...
                <input class="form-control" v-model="customer_address" type="text" name="customer_address"
                  id="customer_address" />
